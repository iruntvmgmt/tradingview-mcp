...
Last generated: 2026-07-06 21:34 UTC
...
| `chart_set_visible_range` | `dom` | unverified | ⚪ Unverified (untested against live app) | 🟡 Open: set_visible_range still uses Strategy Tester date-range presets (1D/5D/1M/3M/6M/1Y/5Y/All via data-name attributes), not absolute dates. Live investigation found no usable internal TV Desktop 3.2.0 range API across known globals. ExperimentController guards against unsafe preset-window execution and Free-tier bar-budget overrun; Accessibility-enabled Alt+G remains the next viable investigation path. |
...
- **Opened:** 2026-07-05
- **Detail:** docs/handoff/2026-07-07-absolute-date-window-investigation.md
